<div class="mt-4">
    <div x-data="{ 
        open_money_log: false, 
        open_scoreboard: false, 
        open_headlines: false, 
        open_perks: false, 
        open_previous_rounds: false 
        ...
        <div class="flex flex-row justify-center space-x-4">
            ...
            @if($this->round->round_number > 1)
                <span x-on:click="open_previous_rounds = true">
                    <button type="button" class="bg-white px-5 py-2.5 rounded-md">
                        Previous Rounds
                    </button>
                </span>
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div class="p-8">
                        <!-- Title -->
                        <h2 x-dialog:title class="text-2xl font-bold mb-8">Previous Rounds</h2>
                        ...
                        <div class="rounded-lg bg-white">
                            <div>
                                <div class="pb-4">
                                    <div class="flex flex-row justify-between items-center mb-8">
                                        @foreach($this->game->rounds->filter(fn($r) => $r->round_number < $this->round->round_number) as $r)
                                            <button type="button" wire:click="setPreviousRound({{ $r }})">{{ $r->round_number }}</button>
                                        @endforeach
