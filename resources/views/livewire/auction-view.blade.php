                            ...
                            <div class="w-full">
                                <div class="flex justify-between">
                                    ...
                                    <div class="relative flex items-center max-w-[11rem]">
                                        ...
                                        <span 
                                            class="bg-gray-50 w-11 h-11 font-medium text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block pb-6 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                        >
                                            {{ $o->amount_offered }}
                                        </span>
